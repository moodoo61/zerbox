...
// Create a theme instance with Arabic RTL support
const PAGE_TITLES = {
  '/': 'ZEROLAG - الرئيسية',
...
function App() {
  // Get auth token from localStorage, or null if it doesn't exist
    ...
    <ThemeProvider theme={theme}>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route 
            path="/admin" 
            element={auth ? <AdminLayout setAuth={setAuth} /> : <Navigate to="/login" />}
          >
            <Route index element={<Dashboard auth={auth} />} />
            <Route path="services" element={<ServiceManager auth={auth} />} />
            <Route path="streaming" element={<StreamingManager auth={auth} />} />
            <Route path="apps" element={<AppsManager auth={auth} />} />
            <Route path="notifications" element={<NotificationsManager auth={auth} />} />
            <Route path="delivery-requests" element={<DeliveryRequestsManager auth={auth} />} />
            <Route path="settings" element={<SettingsManager auth={auth} setAuth={setAuth} />} />
          </Route>
